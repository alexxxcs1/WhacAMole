  ...
  return (
    <div className={[style.ViewBox,'childcenter','childcolumn'].join(' ')}>
        ...
        <div className={style.RuleDetial}>
            <p>现在我们的小安遇到了点麻烦，让我们一起协助他，帮助他打倒坏地鼠。</p>
            <p>1."告白"安理申排行榜前3名2亿分，前10名1.5亿分，前100名1亿分，前500名5千万分</p>
            <p>2.游戏时长1分钟，点击小易、小艾、诗诗、小邦、小思，即可获得分数（1百万分）</p>
            <p>3.点击安理申产品地鼠，将扣取分数（1百万分）</p>
            <p>4.上方会随机飘过气球，点击气球获得分数（5百万分），出现关键信息</p>
            <p>5.与"告白"安理申活动积分相累计，每1亿分可兑换1竞猜券，可用以"喝彩"的终极大竞猜活动</p>
        </div>
